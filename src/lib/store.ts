...
export type PlayerOption = {
  ...
  surname: string;
  team: string;
  // Canonical team key (same concept as BetFeed row.__teamKey / resolveTeamKey output)
  teamKey?: string;
  teamDisplay?: string;
  logoUrl?: string;
};
...
type State = {
  ...
  selectedTeam: string | null; // canonical team key (resolveTeamKey / row.__teamKey)
  playerSearch: string;
